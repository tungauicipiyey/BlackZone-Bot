...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        " **⌲ Repository :** [Virus-Userbot](https://github.com/tungauicipiyey/Virus-UserBot)\n**⌲ Klik For Deploy :** [┣─[ 𝐁𝐨𝐭 𝐕𝐢𝐫𝐮𝐬 ]─┫](https://heroku.com/deploy?template=https://github.com/tungauicipiyey/Virus-UserBot/tree/Virus-UserBot)\n**⌲ Pemilik :** [TUNGAU](t.me/DamnBitchh)"
    )
