...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/tungauicipiyey/Virus-UserBot.git")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Virus-UserBot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/f4d7d8bd857f49e6c1f11.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```『┣─[ 𝐁𝐋𝐀𝐂𝐊𝐙𝐎𝐍𝐄 𝐁𝐎𝐓 ]─┫ Telah Aktif』```")
    return
